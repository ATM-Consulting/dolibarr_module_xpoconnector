 ...
 */
class xpoconnectorbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "xpoconnector@xpoconnector";
    public $boxlabel;
    public $depends = array("xpoconnector");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/xpoconnector/class/xpoconnector.class.php";
