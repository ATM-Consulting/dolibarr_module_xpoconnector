...
/**
 * 	\defgroup   xpoconnector     Module XPOConnector
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/xpoconnector/core/modules directory.
 *  \file       htdocs/xpoconnector/core/modules/modXPOConnector.class.php
 ...
 */
class modXPOConnector extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->rights_class = 'xpoconnector';
		...
		$this->description = "Description of module XPOConnector";
		// Possible values for version are: 'development', 'experimental', 'dolibarr' or version
		$this->version = '1.0.0';
		// Key used in llx_const table to save module status enabled/disabled (where XPOCONNECTOR is value of property name of module in uppercase)
		...
		// for specific css file (eg: /xpoconnector/css/xpoconnector.css.php)
		...
		//							'css' => array('/xpoconnector/css/xpoconnector.css.php'),	// Set this to relative path of css file if module has its own css file
	 	//							'js' => array('/xpoconnector/js/xpoconnector.js'),          // Set this to relative path of js file if module must load a js on all pages
		...
		$this->langfiles = array("xpoconnector@xpoconnector");

		// Constants
		// List of particular constants to add when module is enabled (key, 'chaine', value, desc, visible, 'current' or 'allentities', deleteonunactive)
		// Example: $this->const=array(0=>array('XPOCONNECTOR_MYNEWCONST1','chaine','myvalue','This is a constant to add',1),
		//                             1=>array('XPOCONNECTOR_MYNEWCONST2','chaine','myvalue','This is another constant to add',0, 'current', 1)
		// );
		$this->const = array();

		// Array to add new pages in new tabs
		// Example: $this->tabs = array('objecttype:+tabname1:Title1:xpoconnector@xpoconnector:$user->rights->xpoconnector->read:/xpoconnector/mynewtab1.php?id=__ID__',  	// To add a new tab identified by code tabname1
        //                              'objecttype:+tabname2:Title2:xpoconnector@xpoconnector:$user->rights->othermodule->read:/xpoconnector/mynewtab2.php?id=__ID__',  	// To add another new tab identified by code tabname2
        ...
        {
        	$conf->xpoconnector=new stdClass();
...
/*
		$this->rights[$r][0] = $this->numero . $r;	// Permission id (must not be already used)
		$this->rights[$r][1] = 'xpoconnector_read';	// Permission label
		$this->rights[$r][3] = 1; 					// Permission by default for new user (0/1)
		...
		$this->rights[$r][0] = $this->numero . $r;	// Permission id (must not be already used)
		$this->rights[$r][1] = 'xpoconnector_delete';	// Permission label
		$this->rights[$r][3] = 1; 					// Permission by default for new user (0/1)
...
*/
		...
		// $this->menu[$r]=array(	'fk_menu'=>'fk_mainmenu=xpoconnector',		// Put 0 if this is a single top menu or keep fk_mainmenu to give an entry on left
		//							'type'=>'top',			                // This is a Top menu entry
		//							'titre'=>'XPOConnector top menu',
		//							'mainmenu'=>'xpoconnector',
		//							'leftmenu'=>'xpoconnector_left',			// This is the name of left menu for the next entries
		//							'url'=>'/xpoconnector/pagetop.php',
		//							'langs'=>'xpoconnector@xpoconnector',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
		//							'position'=>100,
		//							'enabled'=>'$conf->xpoconnector->enabled',	// Define condition to show or hide menu entry. Use '$conf->xpoconnector->enabled' if entry must be visible if module is enabled.
		//							'perms'=>'1',			                // Use 'perms'=>'$user->rights->xpoconnector->level1->level2' if you want your menu with a permission rules
		//							'target'=>'',
		//							'user'=>2);				                // 0=Menu for internal users, 1=external users, 2=both
		// $r++;
		//
		// Example to declare a Left Menu entry into an existing Top menu entry:
		// $this->menu[$r]=array(	'fk_menu'=>'fk_mainmenu=xpoconnector,fk_leftmenu=xpoconnector_left',		    // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
		//							'type'=>'left',			                // This is a Left menu entry
		//							'titre'=>'XPOConnector left menu',
		//							'mainmenu'=>'xpoconnector',
		//							'leftmenu'=>'xpoconnector_left',			// Goes into left menu previously created by the mainmenu
		//							'url'=>'/xpoconnector/pagelevel2.php',
		//							'langs'=>'xpoconnector@xpoconnector',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
		//							'position'=>100,
		//							'enabled'=>'$conf->xpoconnector->enabled',  // Define condition to show or hide menu entry. Use '$conf->xpoconnector->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
		//							'perms'=>'1',			                // Use 'perms'=>'$user->rights->xpoconnector->level1->level2' if you want your menu with a permission rules
		//							'target'=>'',
		//							'user'=>2);				                // 0=Menu for internal users, 1=external users, 2=both
		// $r++;
...
/*
		$this->menu[$r]=array(
			...
			'type'=>'top',			                // This is a Top menu entry
			'titre'=>$langs->trans('TopMenuXPOConnector'),
			'mainmenu'=>'xpoconnector',
			'leftmenu'=>'',
			'url'=>'/xpoconnector/list.php',
			'langs'=>'xpoconnector@xpoconnector',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>100+$r,
			'enabled'=>'$conf->xpoconnector->enabled',	// Define condition to show or hide menu entry. Use '$conf->missionorder->enabled' if entry must be visible if module is enabled.
			'perms'=>'$user->rights->xpoconnector->read',			                // Use 'perms'=>'$user->rights->missionorder->level1->level2' if you want your menu with a permission rules
			'target'=>'',
			'user'=>0
		);
		$r++;
		...
		$this->menu[$r]=array(
			'fk_menu'=>'fk_mainmenu=xpoconnector',			                // Put 0 if this is a top menu
			'type'=>'left',			                // This is a Top menu entry
			'titre'=>$langs->trans('TopMenuXPOConnector'),
			'mainmenu'=>'xpoconnector',
			'leftmenu'=>'xpoconnector_left',
			'url'=>'/xpoconnector/list.php',
			'langs'=>'xpoconnector@xpoconnector',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>100+$r,
			'enabled'=>'$conf->xpoconnector->enabled',	// Define condition to show or hide menu entry. Use '$conf->missionorder->enabled' if entry must be visible if module is enabled.
		...
		$this->menu[$r]=array(
			'fk_menu'=>'fk_mainmenu=xpoconnector,fk_leftmenu=xpoconnector_left',		    // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
			'type'=>'left',			                // This is a Left menu entry
			'titre'=>$langs->trans('LeftMenuXPOConnectorCreate'),
			'mainmenu'=>'xpoconnector',
			'leftmenu'=>'xpoconnector_left_create',
			'url'=>'/xpoconnector/card.php?action=create',
			'langs'=>'xpoconnector@xpoconnector',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>100+$r,
			'enabled'=> '$conf->xpoconnector->enabled',  // Define condition to show or hide menu entry. Use '$conf->missionorder->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
			'perms'=> '$user->rights->xpoconnector->write',			                // Use 'perms'=>'$user->rights->missionorder->level1->level2' if you want your menu with a permission rules
			'target'=>'',
			'user'=>0
		...
		$this->menu[$r]=array(
			'fk_menu'=>'fk_mainmenu=xpoconnector,fk_leftmenu=xpoconnector_left',		    // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
			'type'=>'left',			                // This is a Left menu entry
			'titre'=>$langs->trans('LeftMenuXPOConnectorList'),
			'mainmenu'=>'xpoconnector',
			'leftmenu'=>'xpoconnector_left_list',
			'url'=>'/xpoconnector/list.php',
			'langs'=>'xpoconnector@xpoconnector',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>100+$r,
			'enabled'=> '$conf->xpoconnector->enabled',  // Define condition to show or hide menu entry. Use '$conf->missionorder->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
